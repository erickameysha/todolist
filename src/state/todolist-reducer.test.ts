import {addTodolistAC, changeFilterAC, editTitleSpanAC, removeTodolistAC, todolistsReducer} from './todolist-reducer'
import { v1 } from 'uuid'
...
test('correct todolist should change its name', () => {
    ...
    const endState = todolistsReducer(startState, editTitleSpanAC(todolistId2, newTodolistTitle ) )
